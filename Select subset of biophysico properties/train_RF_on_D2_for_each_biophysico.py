...
for c in range(16,17):
    ...
    for i in range(566):
        train_dataset = np.loadtxt('..//Datasets//D2//Bio-physico//Train//'+str(c)+'_'+str(i)+'.txt',dtype=float)
        val_dataset = np.loadtxt('..//Datasets//D2//Bio-physico//Val//'+str(c)+'_'+str(i)+'.txt',dtype=float)
        ...
        clf = BalancedRandomForestClassifier(n_estimators = 300, random_state=1,
